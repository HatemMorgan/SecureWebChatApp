...
var cryptico = (function() {
    ...
    {
      // it causes the same RSAKey to be generated when using the same passphrase
    ...
    my.encrypt = function(plaintext, publickeystring, signingkey)
    {
      ...
      try
        ...
        // check if the RSA object for signaturing was passed by the caller
        if(signingkey)
        {
            // sign plaintext using RSA and sha256 as hashAlg
    ...
    my.decrypt = function(ciphertext, key)
    {
        ...
        // call decrypt function in RSA object
